...
public:
    ...
    void OpenNetworkConnection(const CAddress& addrConnect, bool count_failure, CSemaphoreGrant* grantOutbound, std::optional<std::string> dest, ConnectionType conn_type);
