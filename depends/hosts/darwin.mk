...
llvm_TOOLS=AR LIPO NM OTOOL RANLIB STRIP
...
# special case some unconventionally named tools
darwin_LIBTOOL = $(build_prefix)/bin/llvm-libtool-darwin
darwin_INSTALL_NAME_TOOL = $(build_prefix)/bin/llvm-install-name-tool
