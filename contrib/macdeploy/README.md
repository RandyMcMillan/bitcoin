...
xar -xf Xcode_11.2.1.xip -C .

./pbzx/pbzx -n Content | cpio -i

find Xcode.app -type d -name MacOSX.sdk -execdir sh -c 'tar -c MacOSX.sdk/ | gzip -9n > /MacOSX10.15.sdk.tar.gz' \;
```

on macOS the process is more straightforward:

```bash
xip -x Xcode_11.2.1.xip
tar -C Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/ -czf MacOSX10.15.sdk.tar.gz MacOSX.sdk
```
...
then download [Xcode 11.2.1](https://download.developer.apple.com/Developer_Tools/Xcode_11.2.1/Xcode_11.2.1.xip).
